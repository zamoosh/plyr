"object" == typeof navigator && function (e, t) {
        ...
        return function (e, t, s) {
            ...
            key: "get", value: function (t) {
                ...
                var i, s = t.target, n = t.changedTouches[0], a = parseFloat(s.getAttribute("min")) || 0,
                    r = parseFloat(s.getAttribute("max")) || 100, o = parseFloat(s.getAttribute("step")) || 1,
    ...
    const C = e => null != e ? e.constructor : null, E = (e, t) => Boolean(e && t && e instanceof t), S = e => null == e,
        A = e => C(e) === Object, P = e => C(e) === String, M = e => C(e) === Function, x = e => Array.isArray(e), N = e => E(e, NodeList),
        L = e => S(e) || (P(e) || x(e) || N(e)) && !e.length || A(e) && !Object.keys(e).length;
    var _ = S, I = A, $ = e => C(e) === Number && !Number.isNaN(e), O = P, j = e => C(e) === Boolean, R = M, D = x, q = N,
        H = e => null !== e && "object" == typeof e && 1 === e.nodeType && "object" == typeof e.style && "object" == typeof e.ownerDocument,
        F = e => E(e, Event), V = e => E(e, KeyboardEvent), U = e => E(e, TextTrack) || !S(e) && P(e.kind),
        B = e => E(e, Promise) && M(e.then), W = e => {
    ...
    function J(e = {}, ...t) {
        ...
        return I(i) ? (Object.keys(i).forEach((t => {
            I(i[t]) ? (Object.keys(e).includes(t) || Object.assign(e, {[t]: {}}), J(e[t], i[t])) : Object.assign(e, {[t]: i[t]});
        })), J(e, ...t)) : e;
    }
    ...
    function de(e = null, t = !1) {
        H(e) && (e.focus({preventScroll: !0}), t && oe(e, this.config.classNames.tabFocus));
    }
    ...
    const pe = {
        ...
        check(e, t, i) {
            ...
            return {api: n, ui: n && me.rangeInput && ("video" !== e || !Q.isIPhone || s)};
        },
    ...
    function fe(e, t, i, s = !1, n = !0, a = !1) {
        ...
        const r = t.split(" ");
        let o = a;
        ge && (o = {passive: n, capture: a}), r.forEach((t => {
    ...
    function Ne(e) {
        ...
        let i = t(e);
        if (null === i && (i = t(this.config.ratio)), null === i && !z(this.embed) && D(this.embed.ratio) && ({ratio: i} = this.embed), null === i && this.isHTML5) {
    ...
    const ze = {
        getIconUrl() {
            ...
            const i = "http://www.w3.org/2000/svg", s = ze.getIconUrl.call(this), n = `${s.cors ? "" : s.url}#${this.config.iconPrefix}`,
            ...
            return ee("span", {...t, class: [t.class, this.config.classNames.hidden].filter(Boolean).join(" ")}, i);
        }, createBadge(e) {
            if (z(e)) return null;
            ...
            })), "button" !== n.element || Object.keys(i).includes("type") || (i.type = "button"), Object.keys(i).includes("class") ? i.class.split(" ").some((e => e === this.config.classNames.control)) || J(i, {class: `${i.class} ${this.config.classNames.control}`}) : i.class = this.config.classNames.control, e) {
                case"play":
            ...
            this.options.quality.sort(((e, t) => {
                ...
                ze.createMenuItem.call(this, {value: e, list: i, type: t, title: ze.getLabel.call(this, "quality", e), badge: n(e)});
            })), ze.updateSetting.call(this, t, i);
        }, setCaptionsMenu() {
            if (!H(this.elements.settings.panels.captions)) return;
            const e = "captions", t = this.elements.settings.panels.captions.querySelector('[role="menu"]'), i = Qe.getTracks.call(this),
                s = Boolean(i.length);
            ...
            ze.toggleMenuButton.call(this, e, i), se(t), ze.checkMenu.call(this), i && (this.options.speed.forEach((i => {
                ze.createMenuItem.call(this, {value: i, list: t, type: e, title: ze.getLabel.call(this, "speed", i)});
            ...
            return Ee(D(this.config.controls) ? this.config.controls : []).forEach((r => {
                if ("restart" === r && c.appendChild(i.call(this, "restart", h)), "rewind" === r && c.appendChild(i.call(this, "rewind", h)), "play" === r && c.appendChild(i.call(this, "play", h)), "fast-forward" === r && c.appendChild(i.call(this, "fast-forward", h)), "progress" === r) {
                    const t = ee("div", {class: `${h.class} plyr__progress__container`}), i = ee("div", ae(this.config.selectors.progress));
                ...
                if ("current-time" === r && c.appendChild(a.call(this, "currentTime", h)), "duration" === r && c.appendChild(a.call(this, "duration", h)), "mute" === r || "volume" === r) {
                    ...
                    if (H(t) && c.contains(t) || (t = ee("div", J({}, h, {class: `${h.class} plyr__volume`.trim()})), this.elements.volume = t, c.appendChild(t)), "mute" === r && t.appendChild(i.call(this, "mute")), "volume" === r && !Q.isIos) {
                        const i = {max: 1, step: .05, value: this.config.volume};
                        t.appendChild(n.call(this, "volume", J(i, {id: `plyr-volume-${e.id}`})));
                    }
                }
                if ("captions" === r && c.appendChild(i.call(this, "captions", h)), "settings" === r && !z(this.config.settings)) {
                    const s = ee("div", J({}, h, {class: `${h.class} plyr__menu`.trim(), hidden: ""}));
                    s.appendChild(i.call(this, "settings", {
                        "aria-haspopup": !0,
                        "aria-controls": `plyr-settings-${e.id}`,
                        "aria-expanded": !1
                    }));
                    const n = ee("div", {class: "plyr__menu__container", id: `plyr-settings-${e.id}`, hidden: ""}), a = ee("div"),
                        r = ee("div", {id: `plyr-settings-${e.id}-home`}), o = ee("div", {role: "menu"});
                    r.appendChild(o), a.appendChild(r), this.elements.settings.panels.home = r, this.config.settings.forEach((i => {
                        ...
                        const n = ee("span", null, He.get(i, this.config)), r = ee("span", {class: this.config.classNames.menu.value});
                        r.innerHTML = e[i], n.appendChild(r), s.appendChild(n), o.appendChild(s);
                        const c = ee("div", {id: `plyr-settings-${e.id}-${i}`, hidden: ""}), h = ee("button", {
                            type: "button",
                            class: `${this.config.classNames.control} ${this.config.classNames.control}--back`
                        });
                        h.appendChild(ee("span", {"aria-hidden": !0}, He.get(i, this.config))), h.appendChild(ee("span", {class: this.config.classNames.hidden}, He.get("menuBack", this.config))), be.call(this, c, "keydown", (e => {
                            "ArrowLeft" === e.key && (e.preventDefault(), e.stopPropagation(), l.call(this, "home", !0));
                        }), !1), be.call(this, h, "click", (() => {
                            l.call(this, "home", !1);
                        })), c.appendChild(h), c.appendChild(ee("div", {role: "menu"})), a.appendChild(c), this.elements.settings.buttons[i] = s, this.elements.settings.panels[i] = c;
                ...
                if ("pip" === r && me.pip && c.appendChild(i.call(this, "pip", h)), "airplay" === r && me.airplay && c.appendChild(i.call(this, "airplay", h)), "download" === r) {
                    const e = J({}, h, {element: "a", href: this.download, target: "_blank"});
            ...
            i.forEach((e => {
                const t = ee("span", {class: this.config.classNames.marker}, ""), i = e.time / this.duration * 100 + "%";
    ...
    const Qe = {
        setup() {
            ...
            const e = Qe.getTracks.call(this, !0), {active: t, language: i, meta: s, currentTrackNode: n} = this.captions,
                a = Boolean(e.find((e => e.language === i)));
            this.isHTML5 && this.isVideo && e.filter((e => !s.get(e))).forEach((e => {
                this.debug.log("Track added", e), s.set(e, {default: "showing" === e.mode}), "showing" === e.mode && (e.mode = "hidden"), be.call(this, e, "cuechange", (() => Qe.updateCues.call(this)));
            ...
            if (-1 !== e) if ($(e)) if (e in i) {
                if (this.captions.currentTrack !== e) {
                    ...
                    this.captions.currentTrackNode = s, ze.updateSetting.call(this, "captions"), t || (this.captions.language = n, this.storage.set({language: n})), this.isVimeo && this.embed.enableTextTrack(n), we.call(this, this.media, "languagechange");
                }
            ...
            const i = Qe.getTracks.call(this), s = e => Number((this.captions.meta.get(e) || {}).default),
    ...
    }, Je = "picture-in-picture", Ge = "inline", Ze = {html5: "html5", youtube: "youtube", vimeo: "vimeo"}, et = "audio", tt = "video";
    const it = () => {
    };
    ...
    class nt {
        constructor(e) {
            t(this, "onChange", (() => {
                ...
                this.enabled && (Q.isIos && this.player.config.fullscreen.iosNative ? this.player.isVimeo ? this.player.embed.requestFullscreen() : this.target.webkitEnterFullscreen() : !nt.native || this.forceFallback ? this.toggleFallback(!0) : this.prefix ? z(this.prefix) || this.target[`${this.prefix}Request${this.property}`]() : this.target.requestFullscreen({navigationUI: "hide"}));
            })), t(this, "exit", (() => {
                if (this.enabled) if (Q.isIos && this.player.config.fullscreen.iosNative) this.target.webkitExitFullscreen(), Ce(this.player.play()); else if (!nt.native || this.forceFallback) this.toggleFallback(!1); else if (this.prefix) {
                    if (!z(this.prefix)) {
    ...
    const rt = {
        addStyleHook() {
            ...
            Object.values({...this.media.style}).filter((e => !z(e) && O(e) && e.startsWith("--plyr"))).forEach((e => {
    ...
    class ot {
        constructor(e) {
            t(this, "firstTouch", (() => {
                ...
                e.supported.ui && e.config.disableContextMenu && be.call(e, t.wrapper, "contextmenu", (e => {
                    ...
                    ze.updateSetting.call(e, "speed"), e.storage.set({speed: e.speed});
        ...
        handleKey(e) {
            const {player: t} = this, {elements: i} = t, {key: s, type: n, altKey: a, ctrlKey: r, metaKey: o, shiftKey: l} = e,
                c = "keydown" === n, h = c && s === this.lastKey;
            if (a || r || o || l) return;
            if (!s) return;
            if (c) {
    ...
    var lt = function (e, t) {
        ...
        e.exports = function () {
            ...
            function o(t, i, s, n) {
                var a, r, l = document, c = s.async, h = (s.numRetries || 0) + 1, u = s.before || e, d = t.replace(/[\?|#].*$/, ""),
                    p = t.replace(/^(css|img)!/, "");
    ...
    const ut = {
        setup() {
            ...
            if (u.setAttribute("src", d), u.setAttribute("allowfullscreen", ""), u.setAttribute("allow", ["autoplay", "fullscreen", "picture-in-picture", "encrypted-media", "accelerometer", "gyroscope"].join("; ")), z(s) || u.setAttribute("referrerPolicy", s), i || !t.customControls) u.setAttribute("data-poster", e.poster), e.media = ne(u, e.media); else {
            ...
            t(this, "load", (() => {
                ...
                z(this.cuePoints) || this.cuePoints.forEach((e => {
                    if (0 !== e && -1 !== e && e < this.player.duration) {
                        ...
                        if (H(t)) {
                            const i = 100 / this.player.duration * e, s = ee("span", {class: this.player.config.classNames.cues});
    ...
    class wt {
        constructor(e) {
            t(this, "load", (() => {
                ...
                this.elements.thumb.time = ee("span", {}, "00:00"), e.appendChild(this.elements.thumb.time), this.elements.thumb.imageContainer.appendChild(e), H(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container), this.elements.scrubbing.container = ee("div", {class: this.player.config.classNames.previewThumbnails.scrubbingContainer}), this.player.elements.wrapper.appendChild(this.elements.scrubbing.container);
            })), t(this, "destroy", (() => {
                ...
                const e = this.player.elements.progress.getBoundingClientRect(),
                    ...
                    s = t.left - e.left + 10, n = t.right - e.left - i.clientWidth - 10, a = this.mousePosX - e.left - i.clientWidth / 2,
                    r = bt(a, s, n);
    ...
    const Tt = {
        insertElements(e, t) {
            O(t) ? te(e, this.media, {src: t}) : D(t) && t.forEach((t => {
                te(e, this.media, t);
            }));
        }, change(e) {
            X(e, "sources.length") ? (Ie.cancelRequests.call(this), this.destroy.call(this, (() => {
                ...
                const {sources: t, type: i} = e, [{provider: s = Ze.html5, src: n}] = t, a = "html5" === s ? i : "div",
                    r = "html5" === s ? {} : {src: n};
                Object.assign(this, {
                    provider: s,
                    type: i,
    ...
    class kt {
        constructor(e, i) {
            if (t(this, "play", (() => R(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then((() => this.ads.play())).catch((() => Ce(this.media.play()))), this.media.play()) : null)), t(this, "pause", (() => this.playing && R(this.media.pause) ? this.media.pause() : null)), t(this, "togglePlay", (e => (j(e) ? e : !this.playing) ? this.play() : this.pause())), t(this, "stop", (() => {
                ...
                if (this.supported.ui && !this.isAudio) {
                    const t = le(this.elements.container, this.config.classNames.hideControls), i = void 0 === e ? void 0 : !e,
        ...
        set volume(e) {
            let t = e;
            O(t) && (t = Number(t)), $(t) || (t = this.storage.get("volume")), $(t) || ({volume: t} = this.config), t > 1 && (t = 1), t < 0 && (t = 0), this.config.volume = t, this.media.volume = t, !z(e) && this.muted && t > 0 && (this.muted = !1);
        }
